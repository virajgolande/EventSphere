...
const Navbar = () => {
  ...
  // Scrolls to a section if we're already on the single-page layout,
  // otherwise navigates to the standalone route (e.g. /events, /contact)
  const handleSectionLink = (sectionId, fallbackRoute) => (e) => {
    if (isOnLandingPage) {
      e.preventDefault();
      ...
      // let it fall through to the fallbackRoute normally
      setOpen(false);
    }
  };
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-2.5">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <NavLink
              to="/events"
              className={linkClass}
              onClick={handleSectionLink("events", "/events")}
            >
              Events
            </NavLink>
            {user && (
            ...
            <NavLink
              to="/contact"
              className={linkClass}
              onClick={handleSectionLink("contact", "/contact")}
            >
              Contact
            </NavLink>
          </div>
